...
class MapView extends Backbone.View
  ...
  initialize: (data)->
    ...
    @zoom = 7
    @closeBtn = $('<a class="close-map" style="width: 50px; height: 50px; position: fixed; bottom: 0; right: 50px; z-index: 1; text-align: center;" href="#"><i class="icon-cancel" style="font-size: 28px; line-height: 50px; color: #303030;"></i></a>')
